<template>
  <div>
    ...
    />
    <!-- Create Button -->
    <a-button type="primary" @click="showModal">Create CV</a-button>
...
const handleOk = handleSubmit(async (formValues) => {
  ...
  formValues.templateUrl = templates[selectedTemplate.value].previewImg;
  if (formValues.templateUrl) {
